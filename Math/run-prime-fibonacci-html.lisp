;;; run-prime-fibonacci-html.lisp — Generate the HTML paper directly
(in-package :cl-user)

(load "fibonacci-viz-generator.lisp")

;; Define the HTML generator in the same package
...
;; Save to file
(let ((html (generate-prime-fibonacci-html)))
  (with-open-file (stream "prime-fibonacci-discovery.html"
                          :direction :output
                          :if-exists :supersede
                          :external-format :utf-8)
    (write-string html stream))
  (format t "Paper saved to: prime-fibonacci-discovery.html~%"))
